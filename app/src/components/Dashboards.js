...
return(
 <div className="sm:bg-white inline-flex flex-col h-[90vh] dark:bg-gray-900 w-[71vw] items-center absolute top-[84px]">
  <div className=''>
  ...
  <div className='sm:flex flex-col p-8 gap-x-20 border rounded-3xl shadow-lg '>
  ...
  <div className='sm:flex flex-row p-8 gap-x-20 border rounded-3xl shadow-2xl mt-10 '>
