...

{
 ...
 return(
  ...
  <div className={`transition-transform duration-300 ${isVisible ? 'translate-x-0' : '-translate-x-full'} flex-col bg-white w-[12vw] h-[100vh] inline-flex  border-x gap-20 dark:bg-gray-900 overflow-hidden shrink-0`}>
